...
$statement2 = $pdo->query('SELECT * FROM t_relax INNER JOIN t_rubriquerelax ON t_rubriquerelax.idRelax = t_relax.id INNER JOIN t_rubrique ON t_rubriquerelax.idRubrique = t_rubrique.id WHERE t_rubrique.activite = "Qi gong" ');
...
<head>
    <meta charset="UTF-8">
    <title>Relax &amp; Enjoy - Qi gong</title>
...
<?php
    ...
    {  
        ...
        if ($listeRelax[$i]['activite'] == 'Qi gong'){
